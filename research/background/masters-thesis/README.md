...
- [`concept-evolution.md`](concept-evolution.md): genealogía conceptual.
- [`argument-evolution.md`](argument-evolution.md): argumentos históricos.
- [`critical-audit.md`](critical-audit.md): auditoría separada.
- [`continuity-with-phd.md`](continuity-with-phd.md): matriz comparativa.
