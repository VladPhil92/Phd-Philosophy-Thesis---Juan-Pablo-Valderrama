...
FASES = [
    dict(
        ...
        entries=[
            ...
            ("SRC-192", "Pop Stefanija & Pierson", "\"Algorithmic Governmentality, Digital Sovereignty, and Agency Affordances\"", "—", "A"),
            ("SRC-193", "Badawy", "\"Algorithmic sovereignty and democratic resilience...\"", "—", "A"),
            ("SRC-194", "Ries, van Dalen-Oskam & Offert", "\"Reproducibility and explainability in digital humanities\"", "—", "A"),
            ("SRC-195", "Burrows", "\"Reproducibility, verifiability, and computational historical research\"", "—", "A"),
        ],
    ),
    dict(
        num=1,
    ...
    dict(
        ...
        entries=[
            ...
            ("SRC-191", "Esposito", "\"Oltre la biopolitica\" / \"Beyond Biopolitics\" (2024, conferencia)", "—", "A"),
    ...
    dict(
        ...
        entries=[
            ...
            ("SRC-186", "Kakoliris", "Jacques Derrida on the Aporias of Hospitality (monografía, no artículo)", "—", "L"),
            ("SRC-187", "Willemse", "\"Paradise Lost in Derrida and Agamben...\"", "—", "A"),
        ],
    ),
    dict(
        num=5,
        ...
        entries=[
            ...
            ("SRC-173", "Papadopoulos", "\"Indigenizing wild animal sovereignty\"", "—", "A"),
